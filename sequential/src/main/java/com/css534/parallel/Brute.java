...
public class Brute implements Serializable {
...
//                    if (k == 0)
//                        System.out.println("dist is from " + row + " " + col + " " + " " + i + " " + j + " " + dist);
...
//            System.out.println(Arrays.toString(FacilityGrid[0][0]));
            for (int k=0 ; k < FacilityGrid.length; k++){
                for (int i = 0; i < FacilityGrid[0].length; i++){
                    for (int j=0; j < FacilityGrid[0][0].length; j++){
...
//            for (int j = 0; j < n; j++)
//                System.out.println(Arrays.toString(FacilityGrid[0][j]));
...
//                System.out.println(globalMaxIndexFav + " " + globalMinimaIndexFav);
